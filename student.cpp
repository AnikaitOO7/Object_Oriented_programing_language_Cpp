/*  Analyze and design classes for a student management system. To create a student class, its constructor, destructor and member functions. • To create a course class, its constructor, destructor and member functions.*/
